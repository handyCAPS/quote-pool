...
class Quote_Pool_Admin {
	 ...
	 * TODO:
	 *
	 * - Rename "Quote_Pool" to the name your plugin
	 *
	 * @since     1.0.0
	 *
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), Quote_Pool::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), Quote_Pool::VERSION );
		}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'Quote Pool Settings', $this->plugin_slug ),
			__( 'Quote Pool', $this->plugin_slug ),
			'manage_options',
			$this->plugin_slug,
